...
//          url: 'http://news-at.zhihu.com/api/4/story/' + _this.detailId + '/long-comments',
          url: '/api/4/story/' + _this.detailId + '/long-comments',
          method: 'GET',
...
//          url: 'http://news-at.zhihu.com/api/4/story/' + _this.detailId + '/short-comments',
          url: '/api/4/story/' + _this.detailId + '/short-comments',
          method: 'GET',
          callback: function (res) {
      ...
      getShortCommentsNext () {
        ...
        _this.loading = true
        ajax({
          url: '/api/4/story/' + _this.detailId + '/short-comments/before/' + _this.id,
          method: 'GET',
          callback: function (res) {
